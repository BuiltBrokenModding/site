...
?>
   <h1>Minecraft Modding</h1>
    ...
    <p style="padding:1em 0em;">These are projects that we have worked on in the past, and no longer support. If the project was created by out team we still reserve all rights. This includes the names, code, files, asserts, and anything attached to the project.</p> 
    <div style="padding:0em 1em;"> 
        <div>            
             <ul class="products">
                <li>  
