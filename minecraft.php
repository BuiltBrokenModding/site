...
?>
   <h1>Minecraft Modding</h1>
    ...
    <div style="padding:0em 1em;"> 
        ...
        </h2>If you want to see our SingleBlockMods <a href="minecraft_sbm.php">Click here</a></h2>
        </div>
    </div>
    <hr>
    </br>
    ...
    <h1> Work in Progress Projects </h1>
     <p style="padding:0em 1em;">Bugs are just bonuses waiting to be exploited :)</p>
     </br>
    <div style="padding:0em 1em;"> 
        <div>
             <ul class="products">
                ...
                <li> 
                    ...
                    <p style="padding:0em 1em;"> 
                       Ah, those good old days of being in a workshop with motor oil on your hands and a creation coming to life. Oh, never had that experience well don't worry it is not a requirement. Tinker Toys is our attempt to provide the player with the chance to build robots with endless modifications.   </p>
                </li>
                <li>  
                    <h4><a href="pages/militarybasedecor/">Military Base Decor</a></h4>
                    <p style="padding:0em 1em;"> 
                       What is the point of having guns, armor, tanks, planes, missiles, and all the good old stuff in a boring base? Military base decor provides all the missing pieces to make your base look like a military base. Don't worry it is not just for looks. It provides all the defense while still giving you the exact look you want. Who knows maybe it will look so nice your enemy will not nuke you; but, if it does feel safe in knowing it will outlast even the strongest of bombs.</p> 
                </li>
            </ul>
        </div>
    </div>     
