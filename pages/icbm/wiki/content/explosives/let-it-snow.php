<?php include($_SERVER['DOCUMENT_ROOT'] . "/pages/icbm/wiki/wiki.top.php"); ?>
    <h2 style="text-align:center"> Micro Warhead - Let It Snow Fit </h2>
    <br/>
    <div>
    <div style="float:left; width:47%; margin-right:3%">
    <iframe align="right" width="420" height="315" src="https://www.youtube.com/embed/SfYcF8fqjl0?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
    </div>
    ...
    <img style="display:block; margin-left:auto; margin-right:auto" src="../../../../../img/icbm/recipe-microwarhead-let-it-snow.png" width="108" height="108" alt="Micro Warhead - Let It Snow Fit recipe"/>
    <br/>
    <p>
    ...
    <br/>
    <h2>History</h2>
    <p>Previewed on 12/10/2015 on <a href="https://www.youtube.com/watch?v=SfYcF8fqjl0">DarkGuardsman's channel</a>.</p>
    <br/>
    </div>
    </div>
