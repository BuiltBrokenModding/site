<?php include($_SERVER['DOCUMENT_ROOT'] . "/pages/icbm/wiki/wiki.top.php"); ?>
    ...
    <img style="display:block; margin-left:auto; margin-right:auto" src="../../../../../img/icbm/recipe-microwarhead-fire-bomb.png" width="109" height="109" alt="Micro Warhead - Fire Bomb Fit recipe"/>
    <br/>
    <p>
