...
?>
    ...
    <h2>!!Downloads!!</h2>
    <p> Downloads are not listed for this version as of yet </p>
    
<?php 
//echo FileHelper::get_text("http://ci.builtbroken.com/maven/icbm/ICBM/downloads/downloads-1.5.2.php");
