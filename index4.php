...
<body>
	...
	<div class="mainContent" style="top:64px; text-align:center;">
		<nav class="inlineContent" style="margin:0; padding:0;">
        	
			<a href="/index.html" class="inlineContent ContentButton">Home</a><a href="/software.html" class="inlineContent ContentButton">Projects</a><a href="/mods.html" class="inlineContent ContentButton">Addons</a>
		</nav>
		
			<!-- Javascript photo banner -->
		<div class="contentArea" style="height: 254px; position: relative; width:1000px; overflow:visible;" id="photoBanner">
		...
		background:transparent;">
			...
			margin:15px;
			padding:0;
			overflow-y: hidden; /* TODO: Add when content exceeds certain static length. If content will be scalable in the future, alter based on number of objects using javascript */
			overflow-x: hidden;
			background:transparent;
			">
			</div>
